      ...
      <div className="w-10/12 sm:w-8/12 fixed top-2/4 left-2/4 -translate-2/4 bg-[#3f4143] border-6 md:border-8 border-[#e2b714] rounded-2xl md:rounded-4xl p-5 md:p-10">
        <div className="w-full h-full relative pb-22 space-y-6">
          ...
          <div className={`w-full absolute bottom-0 right-0 flex items-end ${btnName ? "justify-between" : "justify-end"} gap-10`}>
            <button onClick={close} className="text-xl sm:text-2xl md:text-4xl border-4 md:border-6 border-[#e2b714] bg-[#3f4143] rounded-xl sm:rounded-2xl p-2 px-4 cursor-pointer">close</button>
