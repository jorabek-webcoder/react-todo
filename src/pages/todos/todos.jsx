...
function Todos() {
  ...
  return (
    <div className="px-20 py-10 ">
      <div className="w-full border-b-2 border-[#e2b714] pb-[50px] flex items-center justify-between">
        <h1 className="text-6xl font-bold">Todo List</h1>

        <AddTodo />
      </div>

      <div className="w-full h-[63vh] overflow-auto mt-[50px] px-20 flex flex-col gap-4">
